...
public class LoginException extends RuntimeException {
	...
	private static String getErrorMessage(String errorCode) {
		// from
		// http://code.google.com/intl/fr-FR/apis/accounts/docs/AuthForInstalledApps.html
	...
	private final String googleErrorCode;

	public LoginException(String googleErrorCode) {
		super(getErrorMessage(googleErrorCode).isEmpty() ? googleErrorCode
				: getErrorMessage(googleErrorCode));
