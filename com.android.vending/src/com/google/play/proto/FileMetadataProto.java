...
public final class FileMetadataProto extends Message {
  ...
  public FileMetadataProto(Integer fileType, Integer versionCode, Long size, String downloadUrl) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof FileMetadataProto)) return false;
    FileMetadataProto o = (FileMetadataProto) other;
  ...
  public static final class Builder extends Message.Builder<FileMetadataProto> {
    ...
    public Builder(FileMetadataProto message) {
      super(message);
